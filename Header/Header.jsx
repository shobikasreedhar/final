...
import headerlogo from "./images/online-pharmacy-high-resolution-logo.png";
  ...
  return (
    <>
      <div className="header">
        <Link to="/">
          <img className="amz_logo" src={headerlogo} alt="Error" />
        </Link>
        ...
        <div className="header_nav">
          ...
          <div className="header-option">
            ...
            <span className="header_op_l2 responsive">
              Account & Lists <BsFillCaretDownFill />{" "}
            </span>
          </div>
